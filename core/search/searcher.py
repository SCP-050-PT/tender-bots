...
def _load_exclude_keywords() -> List[str]:
    ...
    return [
        "лицензия МЧС", "медицинские работники", "водительские права", "гражданская оборона",
        "категорированные организации", "охранники с оружием", "лицензия ФСБ", "гостайна",
        "исследования воды", "смывы", "гельминты", "биология", "микробиолог",
        "экспертиза промышленной безопасности", "техническая диагностика", "промбезопасность",
        
        # === v7.3.0: НОВЫЙ ЧЕРНЫЙ СПИСОК ===
        # Форумы и ивенты
        "организации и проведению", "образовательный форум", "форум для", "питание", 
        "кофе-брейк", "трансфер", "туристического класса", "творческих коллективов", 
        "видеоролик", "деловая игра", "оценку компетенций",
        
        # ЭТЛ и Пожарка (не наш профиль)
        "замеров сопротивления изоляции", "измерения заземления", "сопротивления цепи фаза-нуль",
        "электролаборатория", "испытания электроизолирующих перчаток", "сопротивления растеканию тока",
        "гидравлическое испытание", "испытание пожарных кранов", "испытание пожарных гидрантов",
        "перекатка пожарных рукавов", "проверка пожарных кранов", "испытание сети внутреннего противопожарного водопровода",
        
        # Диагностика и Холод (v7.3.0)
        "диагностика технического состояния", "холодильной машины", "чиллер", "восстановления ее работоспособности",
        "york", "ремонт оборудования",
        
        # Стройка и Проектирование
        "проектной документации", "строительно-монтажных", "реконструкции", "котлоагрегата",
        
        # Атмосфера (если нет в аккредитации, но лучше блокировать на поиске, если точно не делаем)
        # "атмосферным воздухом", "санитарно-защитной зоны" -> Оставим в релевантности, но проверим в роутере
    "лицензия МЧС", "медицинские работники", "водительские права", "гражданская оборона",
        "категорированные организации", "охранники с оружием", "лицензия ФСБ", "гостайна",
        "исследования воды", "смывы", "гельминты", "биология", "микробиолог",
        "экспертиза промышленной безопасности", "техническая диагностика", "промбезопасность",
...
SEARCH_CONFIG = {
    ...
    "relevance_keywords": [
        ...
        # === v7.3.0: ПЛК и Санитария ===
        "производственный лабораторный контроль", "плк", "лабораторные исследования",
        "санитарно-гигиенические исследования", "замеры вредных факторов", "инструментальный контроль",
        "производственный контроль", "санитарных правил", "санитарно-противоэпидемических",
        "атмосферным воздухом", "санитарно-защитной зоны", # Добавили для поиска, фильтрация в роутере
    ],
